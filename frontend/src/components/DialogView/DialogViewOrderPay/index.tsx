...
export default function DialogViewOrderPay({ visible, order, onClose }: Props) {
  if (!visible || !order) return null;

  return (
    <div className="proj-dialog-order-pay-overlay">
      <div className="proj-dialog-order-box">
        <h2>Ordem para Pagameno</h2>
        <div className="proj-dialog-order-pay-content">
          <h4>ENTRADA</h4>
        ...
        <div className="proj-dialog-order-pay-content">
          ...
          <p><strong>Resta Pagar: </strong> 
            R$ {(order.totalAmount - order.paidValue).toFixed(2)}
          </p>
        </div>

        <div className="proj-dialog-order-pay-actions">
